...
<center>
<a href="https://www.gocomics.com/calvinandhobbes/2015/08/26"> <img src="https://upload.wikimedia.org/wikipedia/en/b/b2/Calvin_and_Hobbes_Original.png" width="500px"> </a>
</center>

.footnote[https://www.gocomics.com/calvinandhobbes/2015/08/26]
---
class: transition middle animated slideInLeft
...
<img src="images/lecture-01A/tips.png" width="100%">
...
- .monash-blue2[observed vs fitted values] to check strength and appropriateness of the fit
- .monash-blue2[univariate plot, and normal probability plot, of residuals] to check for normality
- in the simple final model like this, the .monash-blue2[observed vs predictor], with model overlaid would be advised to assess the model relative to the variability around the model
- when the final model has more terms, using a .monash-blue2[partial dependence plot] to check the relative relationship between the response and predictors would be recommended.
